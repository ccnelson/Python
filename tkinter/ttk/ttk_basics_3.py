...
## 5th frame##
fifth_frame = _build_label_frame(mainframe, 1, 3, "5th frame")
fifth_frame_label = _build_label(fifth_frame, 0, 0, "5th frame label", 30)
fifth_frame_label.grid(columnspan=2)
fifth_frame_text = _build_text(fifth_frame, "words", 10, 0, 1, 5, 10)
fifth_frame_text_2 = _build_text(fifth_frame, "more words", 10, 1, 1, 5, 10)
## prog starts here ##
